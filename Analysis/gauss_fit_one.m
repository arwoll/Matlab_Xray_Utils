...
peak_data = find_peak(x, y, 'mode', 'lin', 'back', [1:5 (length(y)-5:length(y))]);
...
nonlin_opts = fitoptions('Method', 'NonLinearLeastSquares', 'Display', 'off', ...
    'StartPoint', [peak_data.area mean(peak_data.bkgd) peak_data.com  peak_data.fwhm], ...
    'Weights', wts);
