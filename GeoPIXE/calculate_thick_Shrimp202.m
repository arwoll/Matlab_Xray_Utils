...
f1 = double(imread('SeafoodPellets-9660-Flux1.tiff'));
%fname = 'lpi04_110'; lpi04 is the leaf example
bkr1 = f1(504:585, 301:438); %(y,x)
bkr2 = f1(508:576, 43:201);
%% %%
...
ratio = bkgd./f1c; % calculate ratio incident/transmitted
