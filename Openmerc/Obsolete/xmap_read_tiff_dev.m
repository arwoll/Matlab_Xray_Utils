...
%
% TODO : 6 Feb 2018:
%   * figure out maximum number of files per line, so that this does not
%   need to be auto-detected 
%   * Change initialization of data_line to be the same for all files (call
...
for nline = FIRST_LINE:LAST_LINE
    ...
    for nfile = 1:nfiles
        ...
        data_line = zeros(pixel_size, npx_this_file, files_per_line, 'uint16');
    ...
    data_line = reshape(data_line, pixel_size, npx_this_file*files_per_line);
