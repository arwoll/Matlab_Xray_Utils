function errors = flyscan_to_hdf5(fullspecfilename, scann, varargin)
...
mcafiles = dir(fullfile(datapath, ...
    sprintf('%s_*_%04d_0000_000.tiff', specscan.specfile, specscan.scann)));
if isempty(mcafiles)
    mcafiles = dir(fullfile(datapath, ...
        sprintf('%s_*_%04d_000.tiff', specscan.specfile, specscan.scann)));
    if ~isempty(mcafiles)
       SINGLE_MODE = 1; 
    end
end
