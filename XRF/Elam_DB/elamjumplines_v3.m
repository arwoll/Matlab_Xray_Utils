function [line_e line_int]=elamjumplines_v3(element,E0)
% function [line_e line_int] = elamjumplines_v3(element,E0) 
%
% Using incident energy E0 (keV), returns fluorescence line energies and
% relative intensities from the element with atomic number 'element' as
% calculated using data tabulated in Elam
...
all_edges = ele(element).edge;  % all_edges is an array of edge structures
